...
int main(void) {
	...
	adicionar_tarefa(fabiano, tarefa("Publicar artigo sobre listas gen�ricas em C", false));
	adicionar_tarefa(fabiano, tarefa("Escrever sobre games em SDL e C++", true));
	adicionar_tarefa(fabiano, tarefa("Concluir o curso de microeletr�nica", true));
